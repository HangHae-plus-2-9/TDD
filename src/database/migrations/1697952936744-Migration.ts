...
export class Migration1697952936744 implements MigrationInterface {
  name = 'Migration1697952936744';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."payments_method_enum" AS ENUM('CREDIT_CARD', 'VIRTUAL_ACCOUNT')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."payments_status_enum" AS ENUM('PENDING', 'COMPLETED', 'CANCELED')`,
    );
    await queryRunner.query(
